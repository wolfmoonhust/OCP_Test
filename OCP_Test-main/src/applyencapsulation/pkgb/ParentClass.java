package applyencapsulation.pkgb;

import applyencapsulation.pkga.SuperClass;
...
//        System.out.println("- SuperClass().publicInt = " + c.packageInt);
    }
}
...
public class ParentClass extends SuperClass {
    ...
    void testAccess() {
        ...
        System.out.println("- this.publicInt = " + publicInt);
