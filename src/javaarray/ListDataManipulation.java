...
public class ListDataManipulation {
    public static void main(String[] args) {
        ...
        System.out.println("\ncolorList  after replacing all values: "
                + colorList.toString());
        List myList = colorList.stream().map(s-> s+ "ish").collect(Collectors.toList());
...
//        }
        ...
        String[] firstSt = {"abc", "def", "ghi"};

        List firstLis = List.copyOf(Arrays.asList(firstSt));
        List secondLis1= List.of(Arrays.asList(firstSt));
        List secondLis2= List.of(firstSt);
        List thirdLis = Arrays.asList(firstSt);

        System.out.println("firstSt : " + Arrays.toString(firstSt));
//        firstSt[0] = "PPP";
        thirdLis.set(0,"PPP");
        System.out.println("after firstSt : " + Arrays.toString(firstSt));
        System.out.println("firstLis : " + firstLis.toString());
        System.out.println("secondLis1 : " + secondLis1.toString());
        System.out.println("secondLis2 : " + secondLis2.toString());
        System.out.println("thirdLis : " + thirdLis.toString());
    }
}